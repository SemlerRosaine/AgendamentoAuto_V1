...
import visualizacao.relatorios.ControleAgenda;
...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        micontroleAgenda = new javax.swing.JMenuItem();
        ...
        micontroleAgenda.setIcon(new javax.swing.ImageIcon(getClass().getResource("/visualizacao/imagens/relatorio.png"))); // NOI18N
        micontroleAgenda.setText("Controle de Agenda");
        micontroleAgenda.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                micontroleAgendaActionPerformed(evt);
            }
        });
        menuRelatorios.add(micontroleAgenda);
    ...
    private void micontroleAgendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_micontroleAgendaActionPerformed
        // TODO add your handling code here:
        ControleAgenda tela = new ControleAgenda();
        tela.setVisible(true);
        telaInicio.add(tela);
        try {
            tela.setSelected(true);
        ...
        tela.toFront();
    }//GEN-LAST:event_micontroleAgendaActionPerformed
    ...
    private javax.swing.JMenuItem micontroleAgenda;
