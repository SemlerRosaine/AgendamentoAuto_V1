...
import componente.text.formated.HoraTextField;
...
import visualizacao.componente.DeleteButton;
import visualizacao.componente.EditButton;
import visualizacao.componente.SearchButton;
import visualizacao.componente.TextFieldEnterAction;
import visualizacao.componente.SaveButton;
...
public class TelaAgendamento extends JInternalFrame {
    ...
    MyTableModel<Agendamento> tbAgendados;

    //private List<String> listaHoraAgenda;
    /**
    ...
    public TelaAgendamento() {
        ...
        //this.listaHoraAgenda.add();
        //DefaultComboBoxModel defaultComboBoxModel = (DefaultComboBoxModel) this.jcListaHorariosAgenda.getModel();
        //defaultComboBoxModel.addElement(listaHoraAgenda);
    ...
    private void initComponents() {
        ...
        jTAgendados = new javax.swing.JTable();
        lblDataAgendada = new javax.swing.JLabel();
        txtDataAgendada = new DataTextField();
        lblHoraAgendada = new javax.swing.JLabel();
        txtHoraAgendada = new HoraTextField();
        ...
        txtDataRecepcao = new DataTextField();
        lblHoraRacepcao = new javax.swing.JLabel();
        txtHoraRecepcao = new HoraTextField();
        txtHoraEntregaPrevista = new HoraTextField();
        lblHoraPrometida = new javax.swing.JLabel();
        lblDataEntrega = new javax.swing.JLabel();
        jLabel2 = new javax.swing.JLabel();
        txtDataEntrega = new DataTextField();
        jLabel3 = new javax.swing.JLabel();
        txtHoraEntrega = new HoraTextField();
        ...
        txtDataEntregaPrevista = new DataTextField();
        ...
        txtPesquisaCPF = new TextFieldEnterAction() {
            public void onEnterKeyPress(KeyEvent ke){
                buscaAgendamentos();
            }
        };
        ...
        pnlChecklist.setBorder(javax.swing.BorderFactory.createTitledBorder("Etapas do Agendamento"));
        ...
        pnlChecklistLayout.setHorizontalGroup(
            ...
            .addGroup(pnlChecklistLayout.createSequentialGroup()
                ...
                .addGroup(pnlChecklistLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlChecklistLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(cbxExplicacao, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(cbxEfetivo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(cbxAgendado, javax.swing.GroupLayout.Alignment.LEADING))
                ...
                .addGroup(pnlChecklistLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlChecklistLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(cbxRetorno, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        pnlVeiculoLayout.setHorizontalGroup(
            ...
            .addGroup(pnlVeiculoLayout.createSequentialGroup()
                ...
                .addGroup(pnlVeiculoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lblPlacaVeiculo, javax.swing.GroupLayout.DEFAULT_SIZE, 88, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(pnlVeiculoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtPlacaVeiculo, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(txtNomeCliente, javax.swing.GroupLayout.DEFAULT_SIZE, 495, Short.MAX_VALUE)
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("Agendados"));

        jTAgendados.setModel(construirTableModel());
        jScrollPane1.setViewportView(jTAgendados);

        lblDataAgendada.setText("Data agendada");

        txtDataAgendada.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtDataAgendadaKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtDataAgendadaKeyReleased(evt);
            }
        });
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addComponent(lblDataAgendada, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtDataAgendada, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(177, 177, 177)
                .addComponent(lblHoraAgendada, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(txtHoraAgendada, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Dados Agendamento"));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lblNumeroPrisma, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addComponent(lblConsultor, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtHoraEntrega, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtDataEntregaPrevista, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addComponent(txtHoraRecepcao))
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addComponent(txtHoraEntregaPrevista))))
                    .addComponent(txtMotivoVisita)
                    .addComponent(txtConsultor, javax.swing.GroupLayout.Alignment.TRAILING))
                .addContainerGap())
        );
        ...
        jPanel1.add(jTAgendamento, java.awt.BorderLayout.PAGE_START);
    ...
    private void pesquisaAgenda() {
        ...
        try {
            dataAgenda = dataFormatada.parse(txtDataAgendada.getText());
            buscarAgenda(dataAgenda);
            if (agendamentos.size() > 0) {
                atualizarGridAgendados(agendamentos);
            }
    ...
    private void txtDataAgendadaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDataAgendadaKeyPressed
        
    }//GEN-LAST:event_txtDataAgendadaKeyPressed

    private void txtDataAgendadaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDataAgendadaKeyReleased
       pesquisaAgenda();
    }//GEN-LAST:event_txtDataAgendadaKeyReleased
    ...
    private javax.swing.JTable jTAgendados;
    ...
    private javax.swing.JTextField txtDataEntregaPrevista;
    ...
    private void buscaAgendamentos() {
        if (rbNome.isSelected()) {
            ...
            if ((this.txtPesquisaCPF.getText().trim().length() > 0)) {
    ...
    private void popularCampos() {
        this.txtNomeCliente.setText(this.agendamento.getCliente());
        this.txtCpf.setText(this.agendamento.getCpf());
        this.txtEndereco.setText(this.agendamento.getEndereco());
        this.txtTelefone.setText(this.agendamento.getTelefone());
        ...
        //this.jcListaHorariosAgenda.getModel().setSelectedItem(this.agendamento.get);

    }

    private void populaObjeto() {
        this.agendamento.setTelefone(this.txtTelefone.getText().trim());
        ...
        this.agendamento.setConsultor(this.txtConsultor.getText());
        this.agendamento.setCliente(txtNomeCliente.getText());
        this.agendamento.setCpf(txtCpf.getText());
        this.agendamento.setEndereco(txtEndereco.getText());
        this.agendamento.setVeiculoModelo(txtModeloVeiculo.getText());
        this.agendamento.setVeiculoPlaca(txtPlacaVeiculo.getText());
    }
    ...
    public void buscarAgenda(Date dataAgenda) {
        agendamentos = new AgendamentoDao().buscaAgendandamentoData(dataAgenda);
    }

    /**
     * Metodos que atualizar os dados dentro da tabela sendo que o primeiro
     * somente carrega e o segundo recebe uma lista como parametro
     */
    public void atualizarGridAgendados() {
        this.atualizarGridAgendados(new AgendamentoDao().carregaTodos());
    }

    private void atualizarGridAgendados(List<Agendamento> agendamentos) {
        this.agendamentos = agendamentos;
        this.jTAgendados.removeAll();
        this.tbAgendados.setRowCount(0);
        for (Agendamento agendamento : agendamentos) {
            tbAgendados.addRow(agendamento);
        }
    }

    /**
     * Metodo que realiza a construção da tabela dentro do JTable
     *
     * @return
     */
    private MyTableModel<Agendamento> construirTableModel() {
        this.tbAgendados = new MyTableModel<Agendamento>() {
            @Override
            public void addRow(Agendamento objeto) {
                this.addRow(new String[]{
                    new SimpleDateFormat("HH:mm:ss").format(objeto.getDataAgendamento()),
                    objeto.getCliente(),
                    objeto.getTelefone()
                });
            }
        ...
        this.tbAgendados.setColumnIdentifiers(new String[]{
            "Horário",
            "Nome/Razão social",
            "Telefone"
        });
        return this.tbAgendados;
    }

    /**
     * Metodo que realiza a limpeza dos campos apos salvar e coloca o cursor no
     * campo data agendada
     */
    public void limparCampos() {
        txtCpf.setText(null);
        txtDataAgendada.setText(null);
        txtConsultor.setText(null);
        txtDataEntrega.setText(null);
        txtDataEntregaPrevista.setText(null);
        txtDataRecepcao.setText(null);
        txtEndereco.setText(null);
        txtHoraAgendada.setText(null);
        txtHoraEntrega.setText(null);
        txtHoraEntregaPrevista.setText(null);
        txtHoraRecepcao.setText(null);
        txtModeloVeiculo.setText(null);
        txtPlacaVeiculo.setText(null);
        txtMotivoVisita.setText(null);
        txtNomeCliente.setText(null);
        txtNumeroOS.setText(null);
        txtNumeroPrisma.setText(null);
        txtTelefone.setText(null);
        cbxAgendado.setSelected(false);
        cbxEfetivo.setSelected(false);
        cbxExplicacao.setSelected(false);
        cbxInspecao.setSelected(false);
        cbxOrcamento.setSelected(false);
        cbxRequisicao.setSelected(false);
        cbxRetorno.setSelected(false);
        cbxVeiculoPronto.setSelected(false);
        txtDataAgendada.requestFocus();
